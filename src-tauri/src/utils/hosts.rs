...
/// This is likely by using a third-party program. Because x3lanix-launcher requires access to the authentication server, we have to modify the hosts file to allow access.
